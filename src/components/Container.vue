			...
			<el-container>
				...
				<el-main>
					<el-table :data="tableData">
						<el-table-column prop="date" label="日期" width="140" height="40"></el-table-column>
						<el-table-column prop="name" label="姓名" width="120" height="40"></el-table-column>
						<el-table-column prop="address" label="地址" height="40"></el-table-column>
					</el-table>
				</el-main>
			</el-container>		
		</el-container>
